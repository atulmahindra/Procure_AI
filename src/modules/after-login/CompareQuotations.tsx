  ...
  return (
    <main className="compare-page">
      ...
      <section className="compare-content">
        ...
        <div className="compare-intro"><div><h1>AI recommendation for the Procurement Team</h1></div><div className="intro-actions"><button className="back-button" onClick={onBack}>← Back to upload</button><button className="outline-action">♧ &nbsp; Export report</button><button className="outline-action">□ &nbsp; Share</button></div></div>
